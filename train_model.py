...
class PropertyValuePredictor:
    ...
    def save_model(self, model_path='simple_property_model.joblib'):
    ...
    def load_model(self, model_path='simple_property_model.joblib'):
...
def main():
    ...
    try:
        ...
        training_metrics = predictor.train_model(dataset_file)
          # Save model
        model_filename = 'simple_property_model.joblib'
